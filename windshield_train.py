...
'''
author Baljeet Singh - This program creates and trains the model for recognizing in image whether
the Windshield is damaged or not, and will tell if Windshield is not present in image.
...
train_dir = config['Model']['train_dir']



#Adding Validation Directory for the training of model
validation_dir = config['Model']['validation_dir']
...
model.save(config['Model']['trained_model_windshield'])
