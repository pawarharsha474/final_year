...
the Door is damaged or not, and will tell if Door is not present in image.
...
train_dir = config['Model']['train_dir_door']



#Adding Validation Directory for the training of model
validation_dir = config['Model']['validation_dir_door']
...
model.save(config['Model']['trained_model_door'])
