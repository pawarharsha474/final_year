...
the Hood is damaged or not, and will tell if Hood is not present in image.
...
train_dir = config['Model']['train_dir_hood']



#Adding Validation Directory for the training of model
validation_dir = config['Model']['validation_dir_hood']
...
model.save(config['Model']['trained_model_hood'])
