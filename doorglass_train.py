...
the DoorGlass is damaged or not, and will tell if DoorGlass is not present in image.
...
train_dir = config['Model']['train_dir_doorglass']



#Adding Validation Directory for the training of model
validation_dir = config['Model']['validation_dir_doorglass']
...
model.save(config['Model']['trained_model_doorglass'])
